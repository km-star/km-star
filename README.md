...
Cloud            →  Azure (Function Apps · Logic Apps · RBAC · ARM)
                     AWS (EC2 · S3 · CloudWatch · IAM) · GCP (Apigee X)

DevOps           →  Docker · Kubernetes · Jenkins · CI/CD · Git · Linux
```
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-Kumar_Mahat-blue?style=flat&logo=linkedin)](https://linkedin.com/in/kumar-mahat-b4a431178)
